...
define('_AM_SYSTEM_MODULES_ACCESS_USER_ADD', 'Право доступа пользователя добавлено для ID группы: %s');
define('_AM_SYSTEM_MODULES_ACCESS_USER_ADD_ERROR', 'ОШИБКА: Не удалось добавить право доступа пользователя для ID группы: %s');
...
// 2.7.0
define('_AM_SYSTEM_MODULES_FK_DISABLE', 'Не удалось отключить проверку внешнего ключа.');
define('_AM_SYSTEM_MODULES_FK_ENABLE', 'Не удалось включить проверку внешнего ключа.');
define('_AM_SYSTEM_MODULES_DROP_FAIL', 'Не удалось удалить таблицу: %s.');
define('_AM_SYSTEM_MODULES_DROP_OK', 'Удалена таблица: %s.');
