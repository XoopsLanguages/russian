...
define('XOOPS_LIB_PATH_HELP','Абсолютный путь к каталогу XOOPS библиотек БЕЗ косой черты (слеша). Перенесите папку из директории ' . XOOPS_ROOT_PATH . ' чтобы сделать её безопасной.' );
define('XOOPS_DATA_PATH_LABEL','Директория XOOPS данных' );
define('XOOPS_DATA_PATH_HELP','Абсолютный путь к каталогу XOOPS данных БЕЗ косой черты (слеша). Установить права 777. Перенесите папку из директории ' . XOOPS_ROOT_PATH . ' чтобы сделать её безопасной.' );

define('DB_COLLATION_LABEL','Установки кодировок и сопоставления БД' );
define('DB_COLLATION_HELP',  ' MySQL 4.12 поддерживает изменение кодировки и сопоставления. Однако это сложно, так что не производите изменение, если Вы не уверены относительно своего выбора.');
...
define('ERR_COULD_NOT_WRITE_MAINFILE','Ошибка записи содержимого в файл mainfile.php. Внесите данные в файл mainfile.php вручную.' );