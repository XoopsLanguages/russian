...
define("_PROFILE_MI_DESC","Модуль для управления пользовательскими полями профиля пользователя");
//Main menu links
define("_PROFILE_MI_EDITACCOUNT","Редактировать профиль");
define("_PROFILE_MI_CHANGEPASS","Смена пароля");
define("_PROFILE_MI_CHANGEMAIL","Смена Email");
//Admin links
...
//Configuration items
define("_PROFILE_MI_PROFILE_SEARCH","Показать последние действия в профиле пользователя");
//Pages
define("_PROFILE_MI_PAGE_INFO","Информация о пользователе");
define("_PROFILE_MI_PAGE_EDIT","Редактировать пользователя");
define("_PROFILE_MI_PAGE_SEARCH","Поиск");
define("_PROFILE_MI_STEP_BASIC","Основной");
...
//1.86
define('_PROFILE_MI_PROFILE_CAPTCHA_STEP1', 'Использовать Captcha после второго этапа регистрации?');
define('_PROFILE_MI_PROFILE_CAPTCHA_STEP1_DESC', "Выберите «Да», чтобы добавить дополнительную меру против регистрации спам-ботов");
