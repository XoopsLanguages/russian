...
define("_PM_MAILNOTIFY","%s-У Вас новый ЛС от %s");
define("_PM_MAILMESSAGE","Привет!\n Новый ЛС пришел от %s\n\nНазвание ЛС\n%s\n\nВы можете посмотреть здесь\n%s\n\n-----------\nВы получаете это сообщение, потому что Вы выбрали уведомление, получать новый ЛС\n\nВы можете изменить ЛС-Настройки\n%s\n\nПожалуйста, не отвечайте на это сообщение\n\n---------\nС наилучшими пожеланиями\n%s\n%s\n%s");
