...
define("_PM_DELETED","Ваше сообщение(я) были удалены");
...
define("_PM_SORRY","Сожалею! Вы не зарегистрированный пользователь.");
...
define("_PM_LIMIT","PM на страницу");
...
define("_PM_MAILNOTIFY","%s-У Вас новый PM от %s");
define("_PM_MAILMESSAGE","Привет!\n Новый PM пришел от %s\n\nНазвание PM\n%s\n\nВы можете посмотреть здесь\n%s\n\n-----------\nВы получаете это сообщение, потому что Вы выбрали уведомление, получать новый PM\n\nВы можете изменить PM-Confign\n%s\n\nПожалуйста, не отвечайте на это сообщение\n\n---------\nС наилучшими пожеланиями\n%s\n%s\n%s");
