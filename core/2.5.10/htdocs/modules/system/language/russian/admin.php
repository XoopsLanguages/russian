...
define('_AM_SYSTEM_ADGS_DESC','Вы можете добавлять и редактировать группы пользователей.');
define('_AM_SYSTEM_BANS','Банеры');
define('_AM_SYSTEM_BANS_DESC','Здесь Вы можете управлять банерами.');
define('_AM_SYSTEM_BLOCKS','Блоки' );
define('_AM_SYSTEM_BLOCKS_DESC','Создание и добавление инфомационных блоков блоков  для пользователей.' );
define('_AM_SYSTEM_MODULES','Модули' );
define('_AM_SYSTEM_MODULES_DESC','Установка, удаление и управление модлями.' );
define('_AM_SYSTEM_SMLS','Смайлики');
define('_AM_SYSTEM_SMLS_DESC','Вы и Ваши плользователи могут использовать эти смайлики...');
define('_AM_SYSTEM_RANK','Ранги пользователей');
define('_AM_SYSTEM_RANK_DESC','Здесь Вы сможете добавлять рангди для пользователей.');
define('_AM_SYSTEM_USER','Редактирование пользователей');
define('_AM_SYSTEM_USER_DESC','Здесь Вы сможете добавлять, редактировать и удалять пользователей. Назначить пользователю группы и ранг.');
define('_AM_SYSTEM_PREF','Конфигурация');
define('_AM_SYSTEM_PREF_DESC','Центр управления Вашим сайтом настраивайте системные модули, настраивайте параметры системы.');
define('_AM_SYSTEM_MLUS','Рассылка сообщений по E-mail');
define('_AM_SYSTEM_MLUS_DESC','Если Вам необходимо  отправить почту или PM пользователям, Вы сможете  это сделать сдесь.');
define('_AM_SYSTEM_IMAGES','Менеджер изображений');
define('_AM_SYSTEM_IMAGES_DESC','Здесь Вы сможете управлять изображениями, создавать категории и устанавливать права доступа к ним.');
define('_AM_SYSTEM_AVATARS','Аватары' );
define('_AM_SYSTEM_AVATARS_DESC','Добавьте аватары для пользователей. Они смогут выбрать их в профиле.' );
define('_AM_SYSTEM_TPLSETS','Шаблоны');
define('_AM_SYSTEM_TPLSETS_DESC','Если Вам необходимо сделать изменения в шаблонах, сделайте это здесь.');
define('_AM_SYSTEM_COMMENTS','Комментарии');
define('_AM_SYSTEM_COMMENTS_DESC','Ваши пользователи могут добавлять коментарии к новостям, вебблогам и т.д... Здесь Вы можете управлять коментариями.');
define('_AM_SYSTEM_FILEMANAGER','Менеджер файлов');
define('_AM_SYSTEM_FILEMANAGER_DESC','Здесь Вы сможете управлять всеми файлами своего сайта');
