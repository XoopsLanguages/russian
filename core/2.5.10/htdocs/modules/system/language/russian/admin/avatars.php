...
// Main
define('_AM_SYSTEM_AVATAR_MULTIUPLOAD', 'Мульти-загрузка');
// Infos
...
<li>Пользователи сайта могут прикреплять изображения рядом со своим ником - это называется аватарами.<br>Эта опция может быть отключена в настройках пользователя.</li>
</ul>" );
