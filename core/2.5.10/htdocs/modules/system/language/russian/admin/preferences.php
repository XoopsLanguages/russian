...
define("_MD_AM_MINPASS","Минимально необходимая длина пароля");
define("_MD_AM_MINPASSDSC","");
define("_MD_AM_NEWUNOTIFY","Известить по Email при регистрации нового пользователя?");
...
define("_MD_AM_AVATARW","Максимальная ширина аватара (pixel)");
define("_MD_AM_AVATARWDSC","");
define("_MD_AM_AVATARH","Максимальная высота аватара (pixel)");
define("_MD_AM_AVATARHDSC","");
define("_MD_AM_AVATARMAX","Максимальный размер файла аватара (bytes)");
...
define('_MD_AM_SSLPOSTDSC','Имя переменной используемое для передачи значения сессии через POST. Если Вы не уверены, задайте любое имя, которое трудно угадать.');
define('_MD_AM_DEBUGMODE0','Выключено');
define('_MD_AM_DEBUGMODE1','Включена отладка (встроенный режим)');
define('_MD_AM_DEBUGMODE2','Включена отладка (всплывающее окно)');
define('_MD_AM_DEBUGMODE3','Шаблон отладки Smarty');
...
define('_MD_AM_BADEMAILS','Введите e-mail адреса, которые не могут быть использованы пользователями');
define('_MD_AM_BADEMAILSDSC','В качестве разделителя используйте символ <strong>|</strong>, не чувствительно к регистру, разрешен regex.');
define('_MD_AM_BADUNAMES','Введите имена, которые не могут быть использованы пользователями');
define('_MD_AM_BADUNAMESDSC','В качестве разделителя используйте символ <strong>|</strong>, не чувствительно к регистру, разрешен regex.');
...
define('_MD_AM_BADIPS','Введите IP адреса которые будут блокироваться сайтом.<br>В качестве разделите используйте символ <strong>|</strong>, не чувствительно к регистру, разрешен regex (поэтому точка - «.» означает «любой символ», а «\.» означает «.»).');
...
define('_MD_AM_PREFMAIN','Главные настройки');
...
define('_MD_AM_METAROBOTSDSC','Тэг роботов объявляет поисковым системам, какой контент индексировать и пауков');
...
define('_MD_AM_FOOTERDSC','Вы должны вводить ссылки с указанием полного пути начиная с http:// (https://), иначе ссылки не будут работать корректно на страницах модулей.');
...
define('_MD_AM_CENSORWRDDSC','Вводите слова, которые проверяются в сообщениях пользователей.<br>В качестве разделите используйте символ <strong>|</strong>, не чувствительно к регистру.');
...
define('_MD_AM_MODCACHE','Кеш модуля');
...
define('_MD_AM_SOAP_CLIENTDESC', 'Это адрес сервера.');
define('_MD_AM_SOAP_PROVISION', 'SOAP - Обеспечение');
define('_MD_AM_SOAP_PROVISIONDESC', "Если вы хотите, чтобы новый пользователь инициализировал, скажите \'да\'");
define('_MD_AM_SOAP_PROVISIONGROUP', 'SOAP - Ранг к положению');
define('_MD_AM_SOAP_PROVISIONGROUPDESC', 'Это ряды нового пользователя с сервера.');
define('_MD_AM_SOAP_WSDL', 'SOAP - SOAP WSDL');
define('_MD_AM_SOAP_WSDLDESC', 'Если вам нужна услуга WSDL включить эту опцию.');
define('_MD_AM_SOAP_USERNAME', 'SOAP - SOAP Имя пользователя');
define('_MD_AM_SOAP_USERNAMEDESC', 'Это имя пользователя вашей учетной записи на сервере.');
define('_MD_AM_SOAP_PASSWORD', 'SOAP - SOAP Пароль');
define('_MD_AM_SOAP_PASSWORDDESC', 'Если вам нужен пароль к услуге укажите его здесь.');
define('_MD_AM_SOAP_KEEPCLIENT', 'SOAP - Активный клиент');
define('_MD_AM_SOAP_KEEPCLIENTDESC', 'Храните клиента активным.');
define('_MD_AM_SOAP_FILTERPERSON', 'SOAP - Специальные счета');
define('_MD_AM_SOAP_FILTERPERSONDESC', 'Специальные счета, которые использует XOOPS аутентификации.');
define('_MD_AM_SOAP_CLIENTPROXYHOST', 'SOAP - Proxy имя хоста');
define('_MD_AM_SOAP_CLIENTPROXYHOSTDESC', 'SOAP Servers Proxy Server.');
define('_MD_AM_SOAP_CLIENTPROXYPORT', 'SOAP - Proxy порт');
define('_MD_AM_SOAP_CLIENTPROXYPORTDESC', 'SOAP Servers Proxy Server номер порта <br>т.е.: 0 - 65535');
define('_MD_AM_SOAP_CLIENTPROXYUSERNAME', 'SOAP - Proxy имя пользователя');
define('_MD_AM_SOAP_CLIENTPROXYUSERNAMEDESC', 'SOAP Servers Proxy Server имя пользователя');
define('_MD_AM_SOAP_CLIENTPROXYPASSWORD', 'SOAP - Proxy пароль');
define('_MD_AM_SOAP_CLIENTPROXYPASSWORDDESC', 'SOAP Servers Proxy Server пароль.');
define('_MD_AM_SOAP_SOAP_TIMEOUT', 'SOAP - SOAP Тайм-аут');
define('_MD_AM_SOAP_SOAP_TIMEOUTDESC', 'Keep The Soap Query активный <strong>xx</strong> секунд.');
define('_MD_AM_SOAP_SOAP_RESPONSETIMEOUT', 'SOAP - SOAP Тайм-аут ответа');
define('_MD_AM_SOAP_SOAP_RESPONSETIMEOUTDESC', 'Keep The Soap Query активный <strong>xx</strong> секунд.');
define('_MD_AM_SOAP_FIELDMAPPING', 'Xoops-Auth отображение полей для серверов');
define('_MD_AM_SOAP_FIELDMAPPINGDESC', 'Опишите здесь отображение между полем базы данных Xoops и области системы аутентификации LDAP.' . '<br><br>Формат [Xoops Database field]=[Auth system SOAP attribute]' . '<br>например : email=mail' . '<br>Разделитель |' . '<br><br>!! Для продвинутых пользователей !!');
// Xoops Authentication constants
define('_MD_AM_AUTH_CONFOPTION_XOOPS', 'XOOPS База данных');
define('_MD_AM_AUTH_CONFOPTION_LDAP', 'Стандартная дирректория LDAP');
define('_MD_AM_AUTH_CONFOPTION_AD', 'Microsoft Active Directory &copy');
define('_MD_AM_AUTH_CONFOPTION_SOAP', 'XOOPS Soap аутентификации');
define('_MD_AM_AUTHENTICATION', 'Параметры проверки подлинности');
define('_MD_AM_AUTHMETHOD', 'Метод аутентификации');
define('_MD_AM_AUTHMETHODDESC', 'Какой метод аутентификации, который Вы хотели бы использовать для подписания на пользователей.');
define('_MD_AM_LDAP_MAIL_ATTR', 'LDAP - Email имя поля');
define('_MD_AM_LDAP_MAIL_ATTR_DESC', 'Имя атрибута E-Mail в папке LDAP дерева.');
define('_MD_AM_LDAP_NAME_ATTR', 'LDAP - Common Name имя поля');
define('_MD_AM_LDAP_NAME_ATTR_DESC', 'Имя атрибута Common Name в каталоге LDAP.');
define('_MD_AM_LDAP_SURNAME_ATTR', 'LDAP - Surname имя поля');
define('_MD_AM_LDAP_SURNAME_ATTR_DESC', 'Имя Surname атрибута в каталоге LDAP.');
define('_MD_AM_LDAP_GIVENNAME_ATTR', 'LDAP - Given Name имя поля');
define('_MD_AM_LDAP_GIVENNAME_ATTR_DSC', 'Имя данного атрибута Given Name в каталоге LDAP.');
define('_MD_AM_LDAP_BASE_DN', 'LDAP - Base DN');
define('_MD_AM_LDAP_BASE_DN_DESC', 'В base DN (выделенное имя)  в каталоге LDAP.');
define('_MD_AM_LDAP_PORT', 'LDAP - Номер порта');
define('_MD_AM_LDAP_PORT_DESC', 'Номер порта, необходимые для доступа к серверу каталогов LDAP.');
...
define('_MD_AM_LDAP_MANAGER_DN_DESC', 'DN пользователя позволяют производить поиск (например, менеджер)');
define('_MD_AM_LDAP_MANAGER_PASS', 'Пароль менеджера LDAP');
define('_MD_AM_LDAP_MANAGER_PASS_DESC', 'Пароль пользователя позволяют производить поиск');
define('_MD_AM_LDAP_VERSION', 'Протокол LDAP версии');
define('_MD_AM_LDAP_VERSION_DESC', 'Протокол LDAP версии : 2 or 3');
define('_MD_AM_LDAP_USERS_BYPASS', 'Пользователям разрешается обойти проверку подлинности LDAP');
define('_MD_AM_LDAP_USERS_BYPASS_DESC', 'Пользователи, которые будут удостоверяться с помощью собственного метода XOOPS');
define('_MD_AM_LDAP_USETLS', 'Использовать TLS соединение');
define('_MD_AM_LDAP_USETLS_DESC', 'Используйте соединение TLS (Transport Layer Security). TLS используется стандартный номер порта 389<BR>' . ' и версии LDAP, должен быть установлен в положение 3.');
define('_MD_AM_LDAP_LOGINLDAP_ATTR', 'LDAP Атрибут использовать для поиска пользователя');
define('_MD_AM_LDAP_LOGINLDAP_ATTR_D', 'При выполнении входа используйте имя в опции DN установлено значение да, должно соответствовать XOOPS имени Логин');
define('_MD_AM_LDAP_LOGINNAME_ASDN', 'Войти используя имя в DN');
define('_MD_AM_LDAP_LOGINNAME_ASDN_D', 'Логин XOOPS используется в LDAP DN (например: uid=<loginname>,dc=xoops,dc=org)<br>Запись напрямую читает в LDAP сервере без поиска');
define('_MD_AM_LDAP_FILTER_PERSON', 'Запрос фильтра поиска LDAP, чтобы найти пользователя');
define('_MD_AM_LDAP_FILTER_PERSON_DESC', "Специальный фильтр LDAP, чтобы найти пользователя. @@loginname@@ будет заменять имя для входа пользователям<br> ДОЛЖНЫ БЫТЬ ПУСТОЙ ЕСЛИ ВЫ НЕ ЗНАЕТЕ' !" . '<br />бывший : (&(objectclass=person)(samaccountname=@@loginname@@)) для AD' . '<br />бывший : (&(objectclass=inetOrgPerson)(uid=@@loginname@@)) для LDAP');
...
define('_MD_AM_LDAP_PROVIS', 'Автоматический аккаунт резервирования XOOPS');
define('_MD_AM_LDAP_PROVIS_DESC', 'Создать базу данных пользователей XOOPS, если не существует');
define('_MD_AM_LDAP_PROVIS_GROUP', 'По умолчанию влияют на группу');
define('_MD_AM_LDAP_PROVIS_GROUP_DSC', 'Новый пользователь будет присваиватся к этим группам');
define('_MD_AM_LDAP_FIELD_MAPPING_ATTR', 'Xoops-Auth отображение полей для серверов');
define('_MD_AM_LDAP_FIELD_MAPPING_DESC', 'Опишите здесь отображение между полем базы данных XOOPS и области системы аутентификации LDAP.' . '<br><br>Формат [Xoops Database field]=[Auth system LDAP attribute]' . '<br>пример : email=mail' . '<br>Разделитель |' . '<br><br>!! Для продвинутых пользователей !!');
define('_MD_AM_LDAP_PROVIS_UPD', 'Ведение аккаунта XOOPS ресурсов');
...
define('_MD_AM_CPANELDSC', 'Для внутреннего интерфейса');
define('_MD_AM_WELCOMETYPE', 'Отправка приветственного сообщения');
define('_MD_AM_WELCOMETYPE_DESC', 'Способ отправки приветственное сообщение пользователю после его успешной регистрации.');
define('_MD_AM_WELCOMETYPE_EMAIL', 'Email');
define('_MD_AM_WELCOMETYPE_PM', 'Сообщение');
define('_MD_AM_WELCOMETYPE_BOTH', 'Email и Сообщение');
define('_MD_AM_MODULEPREF', 'Настройки модуля');
// Preference module system
define('_AM_SYSTEM_PREFERENCES_SETTINGS', 'Системные настройки модуля');
