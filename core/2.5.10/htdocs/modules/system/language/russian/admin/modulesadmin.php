...
define("_AM_SYSTEM_MODULES_VIEWLINE","Вид в линию");
...
define("_AM_SYSTEM_MODULES_DUPEN","Повторяющаяся запись в таблице модулей!");
...
<li>Для того, чтобы модуль не отображался в главном меню - установите вес модуля равным нулю</li>
<li>Воизбежание нарушения безопасности <b>НАСТОЯТЕЛЬНО</b> рекомендуется удалить файлы неиспользуемых модулей с сервера</li>
<li>Чтобы изменить порядок модулей (что будет отражено в меню), Вам просто нужно перетащить модули в нужное место.</li>
</ul>");
