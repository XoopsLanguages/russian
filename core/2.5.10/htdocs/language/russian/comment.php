...
define('_CM_DOHTML', 'Включить HTML Tags');
define('_CM_DOAUTOWRAP', 'Автоперенос');
define('_CM_DOXCODE', 'Включить XOOPS Codes');
define('_CM_REFRESH', 'Обновить');
define('_CM_PENDING', 'Ожидание');
...
define('_CM_FROM', 'От');
define('_CM_COMDELETED', 'Комментарий(ии) удален.');
define('_CM_COMDELETENG', 'Не удалось удалить комментарий.');
define('_CM_DELETESELECT', 'Удалить все его дочерние комментарии?');
...
define('_CM_COMAPPROVEUSER', 'Комментарии зарегистрированных пользователей всегда одобрены');
