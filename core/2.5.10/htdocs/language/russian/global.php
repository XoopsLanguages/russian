...
define('_ONLINEPHRASE', '<strong>%s</strong> пользователь(ей) онлайн');
...
define('_MD_ASFILE', 'Хранить как файлы (в каталоге загрузки)');
define('_MD_INDB', "Хранить в базе данных (как двоичные \"blob\" данные)");
...
define('_IMGDISPLAY', 'Показать это изображение?');
...
define('_PROCESSINGDROPPEDFILES', 'Обработка пропущенных файлов...');
...
define('_TOOMANYITEMSERROR', 'Слишком много элементов ({netItems}) будет загружено. Максимальное количество: {itemLimit}!');
...
define('_RETRYFAILTOOMANYITEMS', 'Повторить не удалось - Вы достигли лимита на файл!');
define('_ONLEAVE', 'Файлы загружаются, если Вы уйдете (перейдете на другую страницу), загрузка будет отменена!');
define('_UNSUPPORTEDBROWSERIOS8SAFARI', 'Неустранимая ошибка - этот браузер не позволяет загружать файлы любого рода из-за серьезных ошибок в iOS8 Safari. Пожалуйста, используйте iOS8 Chrome, пока Apple не решит эти проблемы!');
