...
define('_AM_LABEL_COMPACTLOG', 'Удалить повторяющиеся записи');
define('_AM_BUTTON_COMPACTLOG', 'Сжать журнал!');
...
define('_AM_JS_REMOVEALLCONFIRM', 'Все записи будут удалены. Удалить?');
...
define('_AM_LABEL_BAN_BY_IP', 'Забанить IP на проверенных записях:');
define('_AM_BUTTON_BAN_BY_IP', 'IP забанен!');
define('_AM_JS_BANCONFIRM', 'IP забанить OK?');
define('_AM_MSG_BANNEDIP', 'IP-адреса запрещены');
define('_AM_ADMINSTATS_TITLE', 'Сводка журнала протектора');
