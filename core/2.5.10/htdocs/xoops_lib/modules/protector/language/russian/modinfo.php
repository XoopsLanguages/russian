...
if (defined('FOR_XOOPS_LANG_CHECKER') || !defined($constpref . '_LOADED')) {
    ...
    define($constpref . '_ADVISORY', 'Советы по безопасности');
    define($constpref . '_PREFIXMANAGER', 'Менеджер префиксов');
    ...
    define($constpref . '_BANIP_TIME0', 'Забаненное время приостановки IP (сек)');
    ...
    define($constpref . '_DOS_EXPIRE', "Время максимальных нагрузок (сек)");
    ...
    define($constpref . '_DOSOPT_HTA', 'DENY от .htaccess (экспериментальная)');
    ...
    define($constpref . '_DBLAYERTRAP', 'Включить DB Layer улавливать anti-SQL-Injection');
    ...
    define($constpref . '_DBTRAPWOSRV', 'Не проверять _SERVER для anti-SQL-Injection');
    ...
    // 3.60
    define($constpref . '_ADMINSTATS', 'Обзор');
    define($constpref . '_BANIP_TIME0DSC', 'Время приостановки в секундах для автоматического запрета IP');
}
