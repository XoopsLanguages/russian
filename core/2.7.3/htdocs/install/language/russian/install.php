...
define('XOOPS_DATA_PATH_LABEL', 'XOOPS каталог файлов данных');
...
define('XOOPS_URL_LABEL', 'Местоположение веб-сайта (URL)'); // L56
...
define('ERR_WRITING_CONSTANT', 'Не удалось записать константу %s.'); // L122
define('ERR_COPY_MAINFILE', 'Не удалось скопировать файл дистрибутива в %s.');
define('ERR_WRITE_MAINFILE', 'Не удалось выполнить запись в %s. Пожалуйста, проверьте права доступа к файлу и повторите попытку.');
define('ERR_READ_MAINFILE', 'Не удалось открыть %s для чтения.');
...
define('XOOPS_COOKIE_DOMAIN_LABEL', 'Домен для файлов cookie веб-сайта');
define('XOOPS_COOKIE_DOMAIN_HELP', 'Домен для установки файлов cookie. Может быть пустым, полный хост из URL-адреса (www.example.com), или зарегистрированный домен без субдоменов (example.com) делиться между субдоменами (www.example.com и blog.example.com.)');
...
define('XOOPS_ERROR_SEE_BELOW', 'См. сообщения ниже.');
define('MODULES_AVAILABLE', 'Доступные модули');
define('INSTALL_THIS_MODULE', 'Добавить %s');
//2.5.11
define('ERR_COPY_CONFIG_FILE', 'Не удалось скопировать файл конфигурации %s.');
//2.7.0
// website name and slogan
define('_WEBSITE_NAME', 'XOOPS Сайт');
define('_WEBSITE_SLOGAN', 'Просто используйте!');
define('_WEBSITE_META_KEYWORDS', 'xoops, платформа веб-приложений, cms, система управления контентом');
define('_WEBSITE_FOOTER', "Создано XOOPS © 2001-{X_YEAR} <a href='https://xoops.org' rel='external' title='The XOOPS Project'>Проект XOOPS</a>");
define('_WEBSITE_COPYRIGHT', 'Авторские права © 2001-{X_YEAR}');
define('_WEBSITE_DESCRIPTION', 'XOOPS — это динамический объектно-ориентированный скрипт портала с открытым исходным кодом, написанный на PHP.');
