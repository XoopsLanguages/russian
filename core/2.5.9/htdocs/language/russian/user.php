...
define('_US_MAILOK', 'Периодически получать уведомления на email <br />от администраторов и модераторов?');
...
define('_US_EMAILNOSPACES', 'ОШИБКА: Email адреса не содержат пробелов.');
...
define('_US_EMAILTAKEN', 'ОШИБКА: Email адрес уже зарегистрирован.');
...
define('_US_CONFMAIL', 'Подтверждение по email для %s отправлено.');
define('_US_ACTVMAILNG', 'Ошибка отправки уведомлений по email к %s');
define('_US_ACTVMAILOK', 'Уведомление по email к %s отправлено.');
...
define('_US_USECOOKIE', 'Храните мое имя пользователя в куки на 1 год');
define('_US_NO', 'Нет');
