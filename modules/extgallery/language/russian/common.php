...
define('CO_' . $moduleDirNameUpper . '_GDLIBSTATUS', 'Поддержка GD библиотеки: ');
define('CO_' . $moduleDirNameUpper . '_GDLIBVERSION', 'Версия GD библиотеки: ');
define('CO_' . $moduleDirNameUpper . '_GDOFF', "<span style='font-weight: bold;'>Отключено</span> (Эскизы не доступны)");
define('CO_' . $moduleDirNameUpper . '_GDON', "<span style='font-weight: bold;'>Включено</span> (Эскизы доступны)");
...
define('CO_' . $moduleDirNameUpper . '_SERVERUPLOADSTATUS', 'Статус сервера для загрузки: ');
