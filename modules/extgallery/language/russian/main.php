...
define("_MD_EXTGALLERY_CATEGORIESALBUMS","Категории / Альбомы");
define("_MD_EXTGALLERY_ALBUMS","Альбомы");
define("_MD_EXTGALLERY_NBALBUMS","# Альбомы");
define("_MD_EXTGALLERY_NBPHOTOS","# Фото");
define("_MD_EXTGALLERY_DESC","Описание");
define("_MD_EXTGALLERY_SEND_ECARD","Отправить открытку");
define("_MD_EXTGALLERY_EXTRA_INFO","Дополнительное инфо.");
define("_MD_EXTGALLERY_NOPERM","К сожалению, у вас нет разрешения на выполнение этого действия");
define("_MD_EXTGALLERY_PHOTO_TITLE","Название");
define("_MD_EXTGALLERY_PHOTO_WEIGHT","Вес");
define("_MD_EXTGALLERY_RSS","RSS галереи");
...
// Photo page
define("_MD_EXTGALLERY_PREVIEW","Предыдущая");
define("_MD_EXTGALLERY_NEXT","Следующая");
define("_MD_EXTGALLERY_OF","из");
define("_MD_EXTGALLERY_VOTE_FOR_THIS_PHOTO","Проголосовать за эту фотографию");
define("_MD_EXTGALLERY_PHOTO_INFORMATION","Информация о фото");
define("_MD_EXTGALLERY_RESOLUTION","Разрешение");
...
define("_MD_EXTGALLERY_SENDS","отправить");
define("_MD_EXTGALLERY_ALL_PHOTO_BY","все фотографии");
define("_MD_EXTGALLERY_SUBMITTER","Представил");

// Send eCard page
define("_MD_EXTGALLERY_TO","К");
define("_MD_EXTGALLERY_FROM","Из");
define("_MD_EXTGALLERY_FROM_NAME","От имени");
...
define("_MD_EXTGALLERY_CLICK_FOR_MORE","Нажмите здесь, чтобы посмотреть больше фотографий!");
define("_MD_EXTGALLERY_ECARD_TITLE","Открытка от %s для Вас");
...
define("_MD_EXTGALLERY_GFIC_DOWNLOAD","Загрузить оригинальное изображение"); 
define("_MD_EXTGALLERY_GFIC_PLAY","Играть"); 
...
define("_MD_EXTGALLERY_BOOKMARK_TO_BLINKLIST","Закладка для Blinklist");
define("_MD_EXTGALLERY_BOOKMARK_TO_DELICIOUS","Закладка для del.icio.us");
define("_MD_EXTGALLERY_BOOKMARK_TO_DIGG","Закладка для Digg");
define("_MD_EXTGALLERY_BOOKMARK_TO_FARK","Закладка для Fark");
define("_MD_EXTGALLERY_BOOKMARK_TO_FURL","Закладка для Furl");
define("_MD_EXTGALLERY_BOOKMARK_TO_NEWSVINE","Закладка для Newsvine");
define("_MD_EXTGALLERY_BOOKMARK_TO_REDDIT","Закладка для Reddit");
define("_MD_EXTGALLERY_BOOKMARK_TO_SIMPY","Закладка для Simpy");
define("_MD_EXTGALLERY_BOOKMARK_TO_SPURL","Закладка для Spurl");
define("_MD_EXTGALLERY_BOOKMARK_TO_YAHOO","Закладка для Yahoo");
define("_MD_EXTGALLERY_BOOKMARK_TO_FACEBOOK","Закладка для Facebook");
define("_MD_EXTGALLERY_BOOKMARK_TO_TWITTER","Закладка для Twitter");
define("_MD_EXTGALLERY_BOOKMARK_TO_SCRIPSTYLE","Закладка для Scripstyle");
define("_MD_EXTGALLERY_BOOKMARK_TO_STUMBLE","Закладка для Stumble");
define("_MD_EXTGALLERY_BOOKMARK_TO_TECHNORATI","Закладка для Technorati");
define("_MD_EXTGALLERY_BOOKMARK_TO_MIXX","Закладка для Mixx");
define("_MD_EXTGALLERY_BOOKMARK_TO_MYSPACE","Закладка для Myspace");
define("_MD_EXTGALLERY_BOOKMARK_TO_DESIGNFLOAT","Закладка для Designfloat");
define("_MD_EXTGALLERY_BOOKMARK_TO_BALATARIN","Закладка для Balatarin");
define("_MD_EXTGALLERY_BOOKMARK_TO_GOOGLEPLUS","Закладка для Google Plus");
define("_MD_EXTGALLERY_BOOKMARK_TO_GOOGLEREADER","Закладка для Google Reader");
...
define("_MD_EXTGALLERY_SORTNAME","Имя");
define("_MD_EXTGALLERY_SORTNAMEASC","Имя, A до Z");
define("_MD_EXTGALLERY_SORTNAMEDESC","Имя, Z до A");
...
define('_MD_EXTGALLERY_ORDERBY_DESIGNERDESC', 'Идентификатор пользователя, сначала старый');
//1.13
// pk add my user def for new album link
define("_MD_EXTGALLERY_USERALBUM","Показать мой альбом");
