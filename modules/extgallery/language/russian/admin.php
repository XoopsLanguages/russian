...
define('_AM_EXTGALLERY_WATERMARK_FREETYPE_WARN',"<strong>PHP должен быть собран с поддержкой FreeType для включения копирайта. Посетите <a href='http://www.freetype.org/'>FreeType.org</a>, для получения более подробной информации.</strong>");
define('_AM_EXTGALLERY_WATERMARK_CONF',"Конфигурация копирайта");
define('_AM_EXTGALLERY_FONT',"Шрифт");
define('_AM_EXTGALLERY_WATERMARK_TEXT',"Текст копирайта");
...
define('_AM_EXTGALLERY_WATERMARK_COLOR',"Цвет копирайта");
define('_AM_EXTGALLERY_WATERMARK_FONT_SIZE',"Размер шрифта копирайта (px)");
define('_AM_EXTGALLERY_WATERMARK_PADDING',"Обрамление копирайта (px)");
define('_AM_EXTGALLERY_BORDER_CONF',"Конфигурация границы");
...
define('_AM_EXTGALLERY_WATERMARK_BORDER_EXEMPLE',"Копирайт (Водяные знаки) и границы - пример");
