...
define('_MD_WFL_ISAPPROVED', 'Спасибо за Ваш вклад.<br />Ваш запрос одобрен и теперь будет показан в нашем списке.');
define('_MD_WFL_THANKSFORHELP', 'Спасибо, что помогаете сохранять целостность и актуальность каталога.');
define('_MD_WFL_FORSECURITY', 'По соображениям безопасности Ваше имя и IP-адрес будут временно, до момента проверки,записаны.');
define('_MD_WFL_DESCRIPTION', 'Описание');
define('_MD_WFL_SUBMITCATHEAD', 'Форма отправки ссылки');
define('_MD_WFL_MAIN', 'Главная');
define('_MD_WFL_POPULAR', 'Популярные ссылки');
...
define('_MD_WFL_BROKENREPORT', 'Сообщить о поврежденной ссылке');
define('_MD_WFL_SUBMITBROKEN', 'Отправить');
define('_MD_WFL_BEFORESUBMIT', 'Прежде чем отправлять запрос о поврежденной ссылке, пожалуйста, проверьте, что фактический источник ссылки, о которой Вы намереваетесь сообщить, не существует, и что веб-сайт не работает.');
...
define('_MD_WFL_LATESTLIST', 'Последние ссылки');
...
define('_MD_WFL_VOTEAPPRE', 'Ваш голос учтен.');
define('_MD_WFL_THANKYOU', 'Спасибо, что нашли время, чтобы проголосовать на %s'); // %s is your site name
define('_MD_WFL_VOTEONCE', 'Пожалуйста, не голосуйте за один и тот же ресурс более одного раза.');
define('_MD_WFL_RATINGSCALE', 'Шкала составляет 1 - 10 ( 1 плохо, 10 - отлично).');
...
define('_MD_WFL_INTFILEFOUND', 'Вот хорошая ссылка на %s'); // %s is your site name
...
define('_MD_WFL_POPULARITY', 'Популярные ссылки');
...
define('_MD_WFL_DUPLOADSCRSHOT', 'Загрузить скриншот экрана:');
...
Спасибо, что нашли время, высказать свое мнение. Мы хотим дать нашим пользователям возможность быстрее находить качественую информацию.<br><br>Все отзывы будут рассмотрены одним из наших веб-мастеров, прежде чем они будут размещены на веб-сайте.
');
...
define('_MD_WFL_RATEDRESOURCE', 'Оценка ссылки');
define('_MD_WFL_PUBLISHER', 'Опубликовал');
define('_MD_WFL_ERROR', 'Ошибка обновления базы данных: информация не сохранена');
define('_MD_WFL_COPYRIGHT', 'права принадлежат');
define('_MD_WFL_INFORUM', 'Обсудить в форуме');
// added frankblack
define('_MD_WFL_NOTALLOWESTOSUBMIT', 'Вы не можете отправлять ссылки');
define('_MD_WFL_INFONOSAVEDB', 'Информация не сохранена в базе данных: <br><br>');

define('_MD_WFL_NEWLAST', 'Новые представленные на прошлой неделей');
define('_MD_WFL_NEWTHIS', 'Новые представленные на этой неделе');
define('_MD_WFL_THREE', 'Новые поступления за последние три дня');
define('_MD_WFL_TODAY', 'Новые поступления сегодня');
