...
define('_MI_WFL_POPULARDSC', 'Количество просмотров до которого ссылка будет считаться популярной.');

//Display Icons
define('_MI_WFL_ICONDISPLAY', 'Ссылки популярные и новые:');
define('_MI_WFL_DISPLAYICONDSC', 'Выберите способ показа популярных и новых ссылок в списке.');
define('_MI_WFL_DISPLAYICON1', 'Значки');
define('_MI_WFL_DISPLAYICON2', 'Текст');
define('_MI_WFL_DISPLAYICON3', 'Не показывать');

define('_MI_WFL_DAYSNEW', 'Новые ссылки:');
define('_MI_WFL_DAYSNEWDSC', 'Количество дней, когда ссылка будет считаться новой.');
define('_MI_WFL_DAYSUPDATED', 'Обновленные ссылки:');
define('_MI_WFL_DAYSUPDATEDDSC', 'Количество дней, когда ссылка будет считаться обновленной.');

define('_MI_WFL_PERPAGE', 'Количество ссылок на стороне пользователей:');
define('_MI_WFL_PERPAGEDSC', 'Количество ссылок в ккатегории для показа на странице.');

define('_MI_WFL_USESHOTS', 'Показать скриншот экрана?');
define('_MI_WFL_USESHOTSDSC', 'Выберите «Да» для показа скриншотов экрана (изображений) для каждой ссылки.');
define('_MI_WFL_SHOTWIDTH', 'Ширина изображения');
define('_MI_WFL_SHOTWIDTHDSC', 'Ширина для скриншота экрана');
define('_MI_WFL_SHOTHEIGHT', 'Высота изображения');
define('_MI_WFL_SHOTHEIGHTDSC', 'Высота для скриншота экрана');
...
define('_MI_WFL_IMGWIDTHDSC', 'Максимальная ширина изображения при загрузке ссылки');
define('_MI_WFL_IMGHEIGHT', 'Высота изображения');
define('_MI_WFL_IMGHEIGHTDSC', 'Максимальная высота изображения при загрузке ссылки');
...
define('_MI_WFL_ALLOWUPLOADS', 'Разрешить загружать пользователям:');
...
define('_MI_WFL_USETHUMBSDSC', 'WF-Links будет использовать эскизы изображений.<br>Поддерживаемые типы изображений: JPG, GIF, PNG.<br>Установите значение «Нет», чтобы использовать исходное изображение, если не поддерживает этот параметр.');
define('_MI_WFL_DATEFORMAT', 'Формат времени:');
define('_MI_WFL_DATEFORMATDSC', 'Формат времени по умолчанию для WF-links.<br>Подробнее <a href="http://jp.php.net/manual/en/function.date.php" target="_blank">PHP manual</a>');
define('_MI_WFL_SHOWDISCLAIMER', 'Показывать "Отказ от ответственности" перед созданием и отправкой ссылки пользователем?');
...
define('_MI_WFL_SUBMITARTDSC', 'Выберите группы пользователей, которые могут отправлять новые ссылки.');
define('_MI_WFL_RATINGGROUPS', 'Рейтинг ссылок:');
define('_MI_WFL_RATINGGROUPSDSC', 'Выберите группы пользователей, которые могут оценивать ссылку.');
define('_MI_WFL_IMGUPDATE', 'Обновление эскизов?');
define('_MI_WFL_IMGUPDATEDSC', 'Если включено изображения эскизов будут обновляться при каждом обновлении страницы, в противном случае будет использоваться первый полученный эскиз.');
define('_MI_WFL_QUALITY', 'Качество эскизов:');
define('_MI_WFL_QUALITYDSC', 'Качество устанавливается от низкого: 0 до наибольшего: 100');
define('_MI_WFL_KEEPASPECT', 'Установить зависимость соотношения сторон изображения');
define('_MI_WFL_KEEPASPECTDSC', '');
define('_MI_WFL_ADMINPAGE', 'Количество ссылок на стороне администрирования:');
define('_MI_WFL_AMDMINPAGEDSC', 'Количество ссылок для показа в области администрирования модуля.');
define('_MI_WFL_ARTICLESSORT', 'Порядок ссылок по умолчанию:');
define('_MI_WFL_ARTICLESSORTDSC', 'Выберите порядок для списков ссылок.');
...
define('_MI_WFL_COPYRIGHT', 'Установка авторских прав:');
define('_MI_WFL_COPYRIGHTDSC', 'Выберите, чтобы показать внизу страницы уведомление об авторских правах.');
// Description of each config items
define('_MI_WFL_SUBCATSDSC', 'Выберите «Да» для показа подкатегорий.<br>При выборе «Нет» подкатегори будут скрыты.');

// Text for notifications
define('_MI_WFL_GLOBAL_NOTIFY', 'Глобальные');
define('_MI_WFL_GLOBAL_NOTIFYDSC', 'Глобальные параметры уведомлений для ссылок.');
define('_MI_WFL_CATEGORY_NOTIFY', 'Категория');
define('_MI_WFL_CATEGORY_NOTIFYDSC', 'Параметры уведомлений, которые относятся к текущей категории ссылок.');
define('_MI_WFL_LINK_NOTIFY', 'Ссылка');
define('_MI_WFL_FILE_NOTIFYDSC', 'Опции уведомлений, которые применяются к текущей ссылке.');
...
define('_MI_WFL_GLOBAL_LINKMODIFY_NOTIFY', 'Изменить ссылку');
...
define('_MI_WFL_SELECTFORUMDSC', 'Выберите форум, который установлен у Вас, для использования его с WF-Links.');
...
define('_MI_WFL_EDITORCHOICE', 'Выберите редактор, который будет использоваться в административной области.<br>Если у Вас «базовая» установка (Например, Вы используете редактор XOOPS, который предоставляется в стандартном базовом пакете XOOPS), то Вы можете выбрать DHTML и Compact');
define('_MI_WFL_EDITORUSER', 'Редактор для использования (пользователь):');
define('_MI_WFL_EDITORCHOICEUSER', 'Выберите редактор, который будет использоваться в пользовательской области.<br>Если у Вас «базовая» установка (Например, Вы используете редактор XOOPS, который предоставляется в стандартном базовом пакете XOOPS), то Вы можете выбрать DHTML и Compact');
...
define('_MI_WFL_OTHERLINKS', 'Показывать другие ссылки, отправленные пользователем?');
define('_MI_WFL_OTHERLINKSDSC', 'Выберите, будут ли показаны другие отправленные ссылки пользователя на странице.');
define('_MI_WFL_TOTALCHARS', 'Укажите max. количество символов для описания.');
define('_MI_WFL_TOTALCHARSDSC', 'Установите max. количество символов для описания ссылок в категории.');
...
// Version 1.05 RC5
define('_MI_WFL_DATEFORMATADMIN', 'Формат времени в админ:');
define('_MI_WFL_DATEFORMATADMINDSC', 'Формат времени по умолчанию в WF-Links<br>Подробнее <a href="http://jp.php.net/manual/en/function.date.php" target="_blank">PHP manual</a>');
define('_MI_WFL_USEADDRESSDESCR', 'Использовать функцию указания адреса и карты?');
define('_MI_WFL_USEADDRESSDSC', 'Выберите «Да», чтобы использовать функцию адреса и карт при описании ссылки.');
define('_MI_WFL_HEADERPRINT', '[ОПЦИИ ПЕЧАТИ] Заголовок для страницы печати');
define('_MI_WFL_HEADERPRINTDSC', 'Заголовок, который будет напечатан на каждой странице');
...
define('_MI_WFL_FOOTERPRINT', '[ОПЦИИ ПЕЧАТИ] Текст нижнего колонтитула страницы');
define('_MI_WFL_FOOTERPRINTDSC', 'Текст нижнего колонтитула, который будет напечатан на каждой странице');
define('_MI_WFL_BNAME3', 'Спонсорская статистика WF-Links');
...
define('_MI_WFL_USEAUTOSCRSHOTDSC', 'Это автоматически создаст скриншот, основанный на URL-адресе.<br>Это автоматически создаст и загрузит скриншот сайта.<br><strong>Может работать не на всех веб-сайтах.</strong>');
...
define('_MI_WFL_HELP_LICENSE', 'Лицензия');
define('_MI_WFL_HELP_SUPPORT', 'Поддержка');
// Links
