...
define('_AM_WFL_DBERROR', 'Ошибка доступа к базе данных: сообщите об этой ошибке на сайт XOOPS.ORG');
// Other Options
...
define('_AM_WFL_SFILES', 'Ссылок: <strong>%s</strong> ');
...
define('_AM_WFL_CCATEGORY_MODIFY_MOVED', 'Успешно перемещены ссылки в базе данных');
...
define('_AM_WFL_CCATEGORY_DELETED', 'Выбранная категория удалена и база данных успешно обновлена');
...
define('_AM_WFL_LINK_GDON', '<b>Включено</b> (эскизы доступны)');
define('_AM_WFL_LINK_GDOFF', '<b>Отключено</b> (эскизы не доступны)');
...
define('_AM_WFL_LINK_FSCREENSHOTS', 'Путь к скриншотам');
define('_AM_WFL_LINK_FMAINIMAGEDIR', 'Путь к изображениям');
...
define('_AM_WFL_LINK_FOLDERSELECTION', 'Выберите раздел, куда надо загрузить изображение:');
define('_AM_WFL_LINK_FSHOWSELECTEDIMAGE', 'Показать загруженные изображения:');
define('_AM_WFL_LINK_FUPLOADIMAGE', 'Загрузите новое выбранное изображение:');

// Main Index defines
define('_AM_WFL_MINDEX_LINKSUMMARY', 'Статистика модуля');
...
define('_AM_WFL_SUB_FILESWAITINGVALIDATION', 'Ссылки ожидающие проверки: ');
define('_AM_WFL_SUB_APPROVEWAITINGFILE', '<b>Одобрить</b> новую ссылку без проверки.');
define('_AM_WFL_SUB_EDITWAITINGFILE', '<b>Редактировать</b> новую ссылку, а затем одобрить.');
define('_AM_WFL_SUB_DELETEWAITINGFILE', '<b>Удалить</b> новую ссылку.');
define('_AM_WFL_SUB_NOFILESWAITING', 'Нет ссылок, соответствующих этим критериям');
define('_AM_WFL_SUB_NEWFILECREATED', 'Созданы новые данные о соединении в базе данных');
// Vote Information
...
define('_AM_WFL_VOTE_USERAVG', 'Средний рейтинг пользователей');
...
define('_AM_WFL_VOTE_NONREGISTERED', 'Голоса анонимных');
// Modifications
...
define('_AM_WFL_LINK_MODIFYFILE', 'Изменить ссылку');
...
define('_AM_WFL_LINK_FILESSTATUS', 'Сделать ссылку неактивной?<br><span style="font-weight: normal;">Ссылка не будет доступна для пользователей.</span>');
define('_AM_WFL_LINK_SETASUPDATED', 'Установить статус ссылки как обновленная?<br><span style="font-weight: normal;">Будет показан соответствующая иконка.</span>');
define('_AM_WFL_LINK_SHOTIMAGE', 'Выбрать изображение: ');
define('_AM_WFL_LINK_DISCUSSINFORUM', 'Установить в каком форуме будет обсуждение ссылки.');
define('_AM_WFL_LINK_PUBLISHDATE', 'Дата публикации ссылки:');
define('_AM_WFL_LINK_EXPIREDATE', 'Дата окончания срока действия ссылки:');
...
define('_AM_WFL_LINK_SETDATETIMEPUBLISH', ' Укажите дату и время публикации (mm/dd/YYYY)');
define('_AM_WFL_LINK_SETDATETIMEEXPIRE', ' Установить дату/время окончания срока действия ссылки (mm/dd/YYYY)');
define('_AM_WFL_LINK_SETPUBLISHDATE', '<b>Установить дату публикации (mm/dd/YYYY): </b>');
...
define('_AM_WFL_LINK_EXPIREDATESET', ' Срок окончания действия ссылки: ');
define('_AM_WFL_LINK_SETEXPIREDATE', '<b>Установить срок действия ссылки: </b>');
define('_AM_WFL_LINK_DELEDITMESS', 'Удалить отчет о испорченной ссылке?<br><br><span style="font-weight: normal;">После подтверждения <b>Да</b>, отчет будет автоматически удален, и Вы подтвердите, что ссылка теперь работает снова.</span>');
define('_AM_WFL_LINK_MUSTBEVALID', 'Скриншот экрана должен быть размещен каталоге %s .<br>Оставьте поле пустым, если изображение отсутствует.');
...
define('_AM_WFL_LINK_CREATENEWSSTORY', '<b>Создать новость при публикации ссылки</b>');
define('_AM_WFL_LINK_SUBMITNEWS', 'Добавить новую ссылку в качестве новости?<br><span style="font-weight: normal;">Нобходим модуль News</span>');
define('_AM_WFL_LINK_NEWSCATEGORY', 'Выберите категорию новостей для публикации:');
define('_AM_WFL_LINK_NEWSTITLE', 'Название новости:<br><span style="font-weight: normal;">Оставьте пустым для использования названия ссылки</span>');
define('_AM_WFL_LINK_PUBLISHER', 'Имя опубликовавшего ссылку: ');

/**
 * Broken links defines
 */
define('_AM_WFL_SBROKENSUBMIT', 'Сломанные: <strong>%s</strong> ');
define('_AM_WFL_BROKEN_FILE', 'Отчет о сломанных ссылках');
...
define('_AM_WFL_BROKEN_REPORTINFO', 'Информация о сломанных ссылках');
define('_AM_WFL_BROKEN_REPORTSNO', 'Ожидаемые проверки ссылки:');
define('_AM_WFL_BROKEN_IGNOREDESC', '<b>Игнорировать</b> отчет и удаляет только сообщение о сломанной ссылке.');
define('_AM_WFL_BROKEN_DELETEDESC', '<b>Удалить</b> сообщение и неработающую ссылку.');
define('_AM_WFL_BROKEN_EDITDESC', '<b>Редактировать</b> ссылку для устранения проблемы.');
define('_AM_WFL_BROKEN_ACKDESC', '<b>Сообщить</b> - Сообщить опубликовавшему ссылку о сообщении.');
define('_AM_WFL_BROKEN_CONFIRMDESC', '<b>Проверено</b> - Установить подтвержденное состояние сообщения о неработающей ссылке.');
define('_AM_WFL_BROKEN_ACKNOWLEDGED', 'Сообщить');
define('_AM_WFL_BROKEN_DCONFIRMED', 'Проверено');

define('_AM_WFL_BROKEN_ID', 'ID');
define('_AM_WFL_BROKEN_TITLE', 'Название');
define('_AM_WFL_BROKEN_REPORTER', 'Корреспондент');
...
define('_AM_WFL_BROKENFILEDELETED', 'Ссылка и отчет удален из базы данных!');
/**
 * About defines
 */
...
// image admin icon
define('_AM_WFL_ICO_EDIT', 'Редактировать ссылку');
define('_AM_WFL_ICO_DELETE', 'Удалить ссылку');
define('_AM_WFL_ICO_RESOURCE', 'Редактировать ссылку');

define('_AM_WFL_ICO_ONLINE', 'В сети');
define('_AM_WFL_ICO_OFFLINE', 'Не в сети');
define('_AM_WFL_ICO_APPROVED', 'Утверждена');
define('_AM_WFL_ICO_NOTAPPROVED', 'Не одобрена');
...
define('_AM_WFL_ICO_VIEW', 'Просмотреть ссылку');
...
define('_AM_WFL_ICO_RES', 'Редактировать ресурсы/ссылки');
define('_AM_WFL_MOD_URLRATING', 'Рейтинг интернет-контента:');
// Alternate category
define('_AM_WFL_ALTCAT_CREATEF', 'Добавить в альтернативную категорию');
...
define('_AM_WFL_ALTCAT_INFOTEXT', '<ul><li>Через эту форму можно добавлять/удалять ссылки в альтернативные категории.</li></ul>');
define('_AM_WFL_ALTCAT_CREATED', 'Альтернативные категории сохранены!');
...
define('_AM_WFL_RES_INFOTEXT', '<ul><li>Новые ресурсы могут быть добавлены, отредактированы или удалены через эту форму.</li>
    ...
    ');
define('_AM_WFL_LISTBROKEN', 'Отображает ссылки, которые могут быть повреждены. NB: Эти результаты могут быть неточными и должны приниматься в качестве приблизительного руководства.<br><br>Проверьте, действительно ли ссылка существует перед любыми действиями.<br>');
define('_AM_WFL_PINGTIMES', 'Отображает первое приблизительное время округления для каждого канала.<br><br>NB: Эти результаты могут быть неточными и должны приниматься в качестве приблизительного руководства.<br>');

define('_AM_WFL_NO_FORUM', 'Нет сообщений');

define('_AM_WFL_PERM_RATEPERMISSIONS', 'Разрешения для рейтинга');
define('_AM_WFL_PERM_RATEPERMISSIONS_TEXT', 'Выберите группы пользователей, которые могут оценивать ссылку в выбранных категориях.');

define('_AM_WFL_PERM_AUTOPERMISSIONS', 'Автоподтверждение ссылок');
define('_AM_WFL_PERM_AUTOPERMISSIONS_TEXT', 'Выберите группы пользователей, в которых будут автоматически разрешены новые ссылки без вмешательства администратора.');

define('_AM_WFL_PERM_SPERMISSIONS', 'Разрешения для отправки');
define('_AM_WFL_PERM_SPERMISSIONS_TEXT', 'Выберите группы пользователей, которые могут отправлять новые ссылки в выбранные категории.');

define('_AM_WFL_PERM_APERMISSIONS', 'Группы модераторов');
define('_AM_WFL_PERM_APERMISSIONS_TEXT', 'Выберите группы пользователей, у которых есть привилегии модератора для выбранных категорий.');
...
define('_AM_WFL_CATSPONSOR', 'Выберите спонсора:');
...
// Version 1.06 RC1
define('_AM_WFL_READWRITEERROR', 'Вы либо не выбрали файл для загрузки, либо на сервере не установлены права чтения/записи для загрузки этого файла!');
define('_AM_WFL_INVALIDFILESIZE', 'Недопустимый размер файла');
define('_AM_WFL_FILENAMEEMPTY', 'Имя файла пусто');
define('_AM_WFL_NOFILEUPLOAD', 'ОШИБКА! Нет загруженного файла');
...
define('_AM_WFL_MIMENOTALLOW', 'Недопустимый MIME тип: ');
...
// version 1.06 RC-2
define('_AM_WFL_IPAGE_SHOWLATEST', 'Показывать последние ссылки?');
define('_AM_WFL_IPAGE_LATESTTOTAL', 'Сколько показать ссылок?');
define('_AM_WFL_IPAGE_LATESTTOTAL_DSC', '0 - выключает этот параметр.');

//version 1.06 Final
define('_AM_WFL_DOCUMENTATION', 'Документация');
define('_AM_WFL_SHOWNOIMAGE', '');
