<div id="help-template" class="outer">
    ...
    <p><span style="font-family: Arial, sans-serif; font-size: 172%; "><a href="http://xoops.org/modules/newbb/viewforum.php?forum=28/" target="_blank">http://www.xoops.org/modules/newbb/</a><br></span>
    </p>
