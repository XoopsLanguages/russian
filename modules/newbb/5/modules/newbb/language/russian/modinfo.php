...
define('_MI_NEWBB_DISCLAIMER_DESC', 'Введите свое заявление об отказе от ответственности (DISCLAIMER), которое будет показано для выбранного выше варианта (показывать во время создания поста, ответа или оба варианта).');
