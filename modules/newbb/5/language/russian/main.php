...
define('_MD_NEWBB_MARK_ALL_FORUMS', 'Отметить все форумы');
define('_MD_NEWBB_MARK_ALL_TOPICS', 'Отметить все темы');
define('_MD_NEWBB_MARK_UNREAD', 'не прочитано');
define('_MD_NEWBB_MARK_READ', 'читать');
...
define('_MD_NEWBB_LOCKTOPIC', 'Заблокировать эту тему');
define('_MD_NEWBB_UNLOCKTOPIC', 'Разблокировать эту тему');
...
define('_MD_NEWBB_WAITFORAPPROVAL', 'Спасибо. Ваша публикация будет одобрена до публикации.');
...
define('_MD_NEWBB_SUSPEND_IP', 'Заблокированный IP(полный адрес/сетевая маска)');
