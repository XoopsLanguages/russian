...
define('_MI_NEWBB_WELCOMEFORUM', 'Форум для приветствия нового пользователя');
define('_MI_NEWBB_WELCOMEFORUM_DESC', 'Сообщение будет опубликовано в профиле, когда пользователь впервые зайдет на Форум');
