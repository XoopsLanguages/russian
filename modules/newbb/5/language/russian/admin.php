...
define('_AM_NEWBB_AVAILABLE', 'Доступно');
define('_AM_NEWBB_NOTAVAILABLE', '<span style="color:red;">недоступно. </span>');
define('_AM_NEWBB_NOTWRITABLE', '<span style="color:red;">Не доступен для записи</span>');
...
define('_AM_NEWBB_REPORT_PENDING', 'Ожидающий отчет');
define('_AM_NEWBB_REPORT_PROCESSED', 'Обработанный отчет');
...
define('_AM_NEWBB_DIGEST', 'Интересные уведомления');
...
define('_AM_NEWBB_DIGEST_SENT', 'Обработано интересных');
define('_AM_NEWBB_DIGEST_FAILED', 'Интересный пост НЕ обработан');
// admin_forum_manager.php
define('_AM_NEWBB_NAME', 'Имя');
...
define('_AM_NEWBB_SETFORUMORDER', 'Задать вопрос');
define('_AM_NEWBB_BOARDREORDER', 'Форум переупорядочен по Вашей спецификации');
// admin_permission.php
define('_AM_NEWBB_PERMISSIONS_TO_THIS_FORUM', 'Разрешения на тему для этого форума');
define('_AM_NEWBB_CAT_ACCESS', 'Доступ к категории');
define('_AM_NEWBB_CAN_ACCESS', 'Можно получить доступ к форуму');
define('_AM_NEWBB_CAN_VIEW', 'Можно просматривать содержимое темы');
define('_AM_NEWBB_CAN_POST', 'Можно начинать новые темы');
define('_AM_NEWBB_CAN_REPLY', 'Может ответить');
define('_AM_NEWBB_CAN_EDIT', 'Может редактировать собственный пост');
define('_AM_NEWBB_CAN_DELETE', 'Можно удалить свой пост');
define('_AM_NEWBB_CAN_ADDPOLL', 'Можно добавить опрос');
define('_AM_NEWBB_CAN_VOTE', 'Может голосовать');
define('_AM_NEWBB_CAN_ATTACH', 'Может использовать приложение');
define('_AM_NEWBB_CAN_NOAPPROVE', 'Можно отправить напрямую');
define('_AM_NEWBB_CAN_TYPE', 'Можно использовать тип темы');
define('_AM_NEWBB_CAN_HTML', 'Может использовать и отключать/включать HTML в сообщениях');//irmtfan revised
define('_AM_NEWBB_CAN_SIGNATURE', 'Может использовать и отключать/разрешать подпись. По умолчанию устанавливается модуль профиля.');//irmtfan revised
define('_AM_NEWBB_ACTION', 'Действие');
define('_AM_NEWBB_PERM_TEMPLATE', 'Установить шаблон разрешения по умолчанию');
define('_AM_NEWBB_PERM_TEMPLATE_DESC', 'Отредактируйте следующий шаблон разрешения, чтобы его можно было применить к форуму или пару форумов');
define('_AM_NEWBB_PERM_FORUMS', 'Выберите форум');
define('_AM_NEWBB_PERM_TEMPLATE_CREATED', 'Был создан шаблон разрешения');
define('_AM_NEWBB_PERM_TEMPLATE_ERROR', 'Ошибка при создании шаблона разрешения');
define('_AM_NEWBB_PERM_TEMPLATEAPP', 'Применить разрешение по умолчанию');
define('_AM_NEWBB_PERM_TEMPLATE_APPLIED', 'Разрешения по умолчанию были применены к форумам');
define('_AM_NEWBB_PERM_ACTION', 'Инструменты управления разрешениями');
define('_AM_NEWBB_PERM_SETBYGROUP', 'Установка разрешений непосредственно по группам');
...
define('_AM_NEWBB_PRUNE_STORE', 'Храните сообщения в этом форуме, а не удаляйте их');
define('_AM_NEWBB_PRUNE_ARCHIVE', 'Сохранить копию сообщений в Архиве');
define('_AM_NEWBB_PRUNE_FORUMSELERROR', 'Вы забыли выбрать форум(ы), чтобы очистить');
define('_AM_NEWBB_PRUNE_DAYS', 'Удалить темы без ответов:');
define('_AM_NEWBB_PRUNE_FORUMS', 'Форумы будут очищены');
define('_AM_NEWBB_PRUNE_STICKY', 'Сохранять приклеенные темы');
define('_AM_NEWBB_PRUNE_DIGEST', 'Сохраняте интересные темы');
define('_AM_NEWBB_PRUNE_LOCK', 'Сохраняте закрытые темы');
define('_AM_NEWBB_PRUNE_HOT', 'Сохранять темы с большим количеством ответов');
...
define('_AM_NEWBB_VOTE_DELETEDSC', '<strong>Удалеть</strong> выбранную информацию о голосовании из базы данных.');
...
define('_AM_NEWBB_TYPE_FORUM', 'Тип за форум');
...
define('_AM_NEWBB_TYPE_EDITFORUM_DESC', 'Данные еще не сохранены. Вы должны отправить его, чтобы сохранить.');
define('_AM_NEWBB_TYPE_ORDER_DESC', 'Чтобы активировать тип для форума, требуется значение больше 0 для \'type_order\'; Другими словами, тип будет неактивным для форума, если \'type_order\' для 0.');
...
define('_AM_NEWBB_GROUPMOD_TITLE', 'Добавить модераторов на группу');
define('_AM_NEWBB_GROUPMOD_TITLEDESC', 'Позволяет вводить пользователей определенных групп в качестве модераторов');
define('_AM_NEWBB_GROUPMOD_ALLFORUMS', 'Все форумы');
define('_AM_NEWBB_GROUPMOD_ADDMOD', 'Модераторы успешно зарегистрированы.');
define('_AM_NEWBB_GROUPMOD_ERRMOD', 'У Вас есть ошибка!');
// added in V 4.3
define('_AM_NEWBB_UPLOAD', 'Максимальный размер загружаемого файла :');
define('_AM_NEWBB_MEMLIMITTOLARGE', 'Внимание! В \'memory_limit\' установлено в PHP.INI меньше, чем \'post_max_size\'');
define('_AM_NEWBB_MEMLIMITOK', 'Максимальный размер загружаемого файла %s.');
