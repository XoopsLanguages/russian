...
//home
define('_MI_XSITEMAP_HOME', 'Главная');
define('_MI_XSITEMAP_REGISTER', 'Регистрация');
define('_MI_XSITEMAP_LOGIN', 'Вход');
define('_MI_XSITEMAP_SITEMAP', 'Карта сайта');

//Add by urbanspaceman 26/08/2009
//xml
define('_MI_XSITEMAP_MANAGER_XML', 'Управление XML');
...
define('_MI_XSITEMAP_LICENSE', 'Лицензия');
define('_MI_XSITEMAP_SUPPORT', 'Поддержка');
