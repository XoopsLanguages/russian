...
define('_AM_NEWS_ACTION', 'Действие');
...
// Added in Beta6
define('_AM_TOPICSMNGR', 'Управление разделами');
...
define('_AM_NEWS_NEWSLETTER_HEADER', 'Верхний колонтитул');
define('_AM_NEWS_NEWSLETTER_FOOTER', 'Нижний колонтитул');
define('_AM_NEWS_NEWSLETTER_HTML_TAGS', 'Удалить html тэги ?');
define('_AM_NEWS_VERIFY_TABLES', 'Обслуживание таблиц');
define('_AM_NEWS_METAGEN', 'Метагенератор');
define('_AM_NEWS_METAGEN_DESC', 'Метагенератор - система, которая поможет наилучшим образом проиндексировать Вашу страницу для поисковых серверов.<br />Кроме того модуль автоматически создаёт метатэги из ваших слов.');
define('_AM_NEWS_BLACKLIST', 'Черный список');
define('_AM_NEWS_BLACKLIST_DESC', 'Слова из этого списка не будут использоваться в качестве ключевых');
define('_AM_NEWS_BLACKLIST_ADD', 'Добавить');
define('_AM_NEWS_BLACKLIST_ADD_DSC', 'Введите слова для добавления в список<br />(однао слово - одна строка)');
define('_AM_NEWS_META_KEYWORDS_CNT', 'Максимальное количество генерируемых ключевых слов');
define('_AM_NEWS_META_KEYWORDS_ORDER', 'Порядок ключевых слов');
define('_AM_NEWS_META_KEYWORDS_INTEXT', 'Установите порядок появления ключевых слов в тексте');
define('_AM_NEWS_META_KEYWORDS_FREQ1', 'Частота появления слов');
define('_AM_NEWS_META_KEYWORDS_FREQ2', 'Частота появления слов в обратном порядке');
// Added in verisn 1.67
// About.php
define("_AM_NEWS_ABOUT_RELEASEDATE", "Релиз: ");
define("_AM_NEWS_ABOUT_UPDATEDATE", "Обновлено: ");
define("_AM_NEWS_ABOUT_AUTHOR", "Автор: ");
define("_AM_NEWS_ABOUT_CREDITS", "Кредиты: ");
define("_AM_NEWS_ABOUT_LICENSE", "Лицензия: ");
define("_AM_NEWS_ABOUT_MODULE_STATUS", "Состояние: ");
define("_AM_NEWS_ABOUT_WEBSITE", "Вебсайт: ");
define("_AM_NEWS_ABOUT_AUTHOR_NAME", "Имя автора: ");
define("_AM_NEWS_ABOUT_CHANGELOG", "Журнал изменений");
define("_AM_NEWS_ABOUT_MODULE_INFO", "Информация модуля");
define("_AM_NEWS_ABOUT_AUTHOR_INFO", "Информация автора");
define("_AM_NEWS_ABOUT_DESCRIPTION", "Описание: ");
// Configuration check
define("_AM_NEWS_CONFIG_CHECK","Проверка конфигурации");
define("_AM_NEWS_CONFIG_PHP","Минимальные PHP требования: %s (ваша версия %s)");
define("_AM_NEWS_CONFIG_XOOPS","Минимальные XOOPS требования:  %s (ваша версия %s)"); 
define("_AM_NEWS_STATISTICS", "Статистика новостей");
define("_AM_NEWS_THEREARE_STORIES", "Новостей в базе данных: <span class='red bold'>%s</span>");
define("_AM_NEWS_THEREARE_STORIES_ONLINE", "Опубликовано новостей <span class='red bold'>%s</span>");
define("_AM_NEWS_THEREARE_STORIES_FILES", "Истории файлов в базе данных: <span class='red bold'>%s</span>");
define("_AM_NEWS_THEREARE_STORIES_FILES_ONLINE", "Истории файлов онлайн: <span class='red bold'>%s</span>");
define("_AM_NEWS_THEREARE_TOPICS", "Категорий в базе данных: <span class='red bold'>%s</span>");
define("_AM_NEWS_THEREARE_TOPICS_ONLINE", "Категорий в меню: <span class='red bold'>%s</span>");
define("_AM_NEWS_THEREARE_STORIES_VOTEDATA", "Отображенные истории: <span class='red bold'>%s</span>");
define("_AM_NEWS_THEREARE_STORIES_IMPORTED", "Импортированные истории: <span class='red bold'>%s</span>");
define("_AM_NEWS_THEREARE_STORIES_EXPORTED", "Экспорьтрованные истории: <span class='red bold'>%s</span> ");
define("_AM_NEWS_THEREARE_STORIES_EXPIRED", "Новости с истекшим сроком: <span class='red bold'>%s</span>");
define("_AM_NEWS_THEREARE_STORIES_EXPIRED_SOON", "Новости, срок которых скоро истекает: <span class='red bold'>%s</span> ");
define("_AM_NEWS_THEREARE_STORIES_APPROVED", "Одобренныех новостей: <span class='red bold'>%s</span>");
define("_AM_NEWS_THEREARE_STORIES_NEED_APPROVAL", "Неодобренных новостей: <span class='red bold'>%s</span> ");
//1.72
define('_AM_NEWS_UPGRADE_FAILED0', "Обновление не удалось - не удалось переименовать поле '%s'");
define('_AM_NEWS_UPGRADE_FAILED1', "Обновление не удалось - не удалось добавить новые поля");
define('_AM_NEWS_UPGRADE_FAILED2', "Обновление не удалось - не удалось переименовать таблицу '%s'");
define('_AM_NEWS_ERROR_COLUMN', 'Не удалось создать столбец в базе данных: %s');
define('_AM_NEWS_ERROR_BAD_XOOPS', 'Этот модуль требует XOOPS %s+ (%s установлен)');
define('_AM_NEWS_ERROR_BAD_PHP', 'Для этого модуля требуется версия PHP %s+ (%s установлен)');
define('_AM_NEWS_ERROR_TAG_REMOVAL', 'Не удалось удалить теги из модуля тегов');
